/* ===================================
   ...
   Display & Animation Functions Module (PHASE 2 - HIRED & INTERNAL TRANSFER ADDED)
   =================================== */
...
function displayOverviewMetrics(overview) {
    ...
    // UPDATED ORDER: Total, Active, Mobilized, Hold, Inactive, Archive, Completed, Hired, Internal Transfer
    const metrics = [
        { value: overview.total || 0, label: 'Total', id: 'total' },
        { value: overview.active || 0, label: 'Active', id: 'active' },
        { value: overview.mobilized || 0, label: 'Mobilized', id: 'mobilized' },
        { value: overview.hold || 0, label: 'Hold', id: 'hold' },
        { value: overview.inactive || 0, label: 'Inactive', id: 'inactive' },
        { value: overview.archive || 0, label: 'Archive', id: 'archive' },
        { value: overview.completed || 0, label: 'Completed', id: 'completed' },
        { value: overview.hired || 0, label: 'Hired', id: 'hired' },
        { value: overview.internalTransfer || 0, label: 'Internal Transfer', id: 'internal-transfer' }
    ];
    
    // Generate HTML for metric cards (ensure all cards are created at once)
    ...
    // Set all HTML at once to prevent delayed appearance
    container.innerHTML = cardsHtml;
    
    // Animate counters with staggered effect (reduced delay for more professional look)
    setTimeout(() => {
        metrics.forEach((metric, index) => {
            ...
            }, index * 80); // Reduced from 100ms to 80ms for faster, more professional appearance
        });
    }, 50); // Reduced from 100ms to 50ms for faster start
    
    console.log('✅ Overview metrics displayed with Hired & Internal Transfer cards');
}
